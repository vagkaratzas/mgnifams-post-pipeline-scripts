...
if __name__ == "__main__":
    if len(sys.argv) != 3:
        ...
        # Example: python ./bin/parse_s4pred_to_feature_viewer.py /home/vangelis/Desktop/Projects/mgnifams-post-pipeline-scripts/assets/test_data/s4pred output/s4pred
